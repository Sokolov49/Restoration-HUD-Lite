...
function MenuPauseRenderer:show_node( node )
	...
	local parameters = { 	font = "fonts/font_medium_shadow_mf",
							row_item_color = Color( 1, 0.9, 0.9, 0.95), -- tweak_data.menu.default_font_row_item_color, 
							row_item_hightlight_color = Color( 1, 1, 1, 1), -- tweak_data.menu.default_hightlight_row_item_color, 
							...
							marker_alpha = 0.2,
							marker_color = Color( 1, 0.9, 0.9, 0.95),
...
function MenuPauseRenderer:update( t, dt )
	...
	self._menu_bg:set_gradient_points( { 0, Color( 1, 0, 0, 0), (math.sin( t * 10 ) + 1)/2, Color(0.0, 0, 0.4, 0.6), 1, Color( 1, 0, 0, 0 ) } )
end